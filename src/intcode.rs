...
impl Intcode {
    ...
    pub fn set_imm(&mut self, i: i64, value: i64) {
        self.set_mem(self.index(i, ParamMode::Immediate), value);
    }
    ...
    pub fn run<F>(&mut self, mut input_fn: F) -> ExitMode
    where
        F: FnMut() -> i64,
    {
        loop {
